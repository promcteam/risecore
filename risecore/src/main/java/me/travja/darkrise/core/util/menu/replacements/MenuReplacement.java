package me.travja.darkrise.core.util.menu.replacements;
...
public abstract class MenuReplacement {
    ...
    public static class DataBank {
        ...
        static {
            ...
            defaultReplacements.add(new PlayerReplacement("$<player.location>", (player) -> Utils.locToString(player.getLocation())));
        }
    }
