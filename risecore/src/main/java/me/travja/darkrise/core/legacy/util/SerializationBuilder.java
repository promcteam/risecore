...
/*    public SerializationBuilder append(final String str, final ConfigurationSerializable object) {
    ...
    public SerializationBuilder append(final String str, Object object) {
        if (object instanceof Enum) {
            ...
            return this.append(str, ((IntRange) object).getMinimumInteger() + "-" + ((IntRange) object).getMaximumInteger());
        } else if (object instanceof LongRange) {
            return this.append(str, ((LongRange) object).getMinimumLong() + "-" + ((LongRange) object).getMaximumLong());
        } else if (object instanceof FloatRange) {
            return this.append(str, ((FloatRange) object).getMaximumFloat() + "-" + ((FloatRange) object).getMaximumFloat());
        } else if (object instanceof DoubleRange) {
            return this.append(str, ((DoubleRange) object).getMinimumDouble() + "-" + ((DoubleRange) object).getMaximumDouble());
