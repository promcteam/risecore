...
public abstract class RiseCommand implements CommandExecutor, TabCompleter {
    ...
    private HashSet<RiseCommand> children = new HashSet<>();
...
//        }
        ...
        MessageUtil.sendMessage(usage, sender, new MessageData("text", (s.isEmpty() ? "" : s + " ") + StringUtils.join(args, " ")));
    }

    public boolean checkPermission(CommandSender sender, String permission) {
        return sender instanceof ConsoleCommandSender || ((Player) sender).hasPermission(permission);
    }
    ...
    @Override
    public @Nullable List<String> onTabComplete(CommandSender commandSender, Command command, String label, String[] strings) {
        return null;
    }
}
