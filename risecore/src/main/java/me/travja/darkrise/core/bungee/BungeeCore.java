...
import me.travja.darkrise.core.legacy.killme.chat.utils.ComponentUtils;
...
public class BungeeCore extends Plugin implements Listener {
    public void onEnable() {
        ...
        getLogger().info("BungeeRiseCore has been enabled!");
    }
        ...
        try {
            ...
            if (command.equals("Broadcast")) {
                ...
                if (targetPlayer != null && targetPlayer.isConnected()) {
                    targetPlayer.sendMessage(ComponentUtils.fromLegacyText(msgin.readUTF()));
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
