...
public class ItemComparator {
    ...
    private static boolean isSimilarSpigot(ItemStack stack1, ItemStack stack2) {
        if (stack1 == null) {
            ...
            return stack2.getType() == stack1.getType() && stack2.getDurability() == stack1.getDurability() && stack2.hasItemMeta() == stack1.hasItemMeta() && (!stack1.hasItemMeta() || Bukkit.getItemFactory().equals(stack2.getItemMeta(), stack1.getItemMeta()));
        }
    }
    ...
    public static boolean isSimilar(ItemStack stack1, ItemStack stack2) {
        ...
        return isSimilarSpigot(stack1, stack2) ||
                stack2.getType() == stack1.getType() && stack2.getDurability() == stack1.getDurability() &&
                        ...
                        (!stack1.hasItemMeta() || checkLore(stack1.getItemMeta().getLore(), stack2.getItemMeta().getLore()));
