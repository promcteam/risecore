...
import me.travja.darkrise.core.util.menu.replacements.MenuReplacement;
import me.travja.darkrise.core.util.menu.replacements.PlayerReplacement;
import me.travja.darkrise.core.util.patterns.InventoryPattern;
...
import static me.travja.darkrise.core.util.Utils.isAir;
...
public class ItemMenu implements InventoryHolder {
    ...
    @Getter
    private List<MenuReplacement> textReplacements = new ArrayList<>();
