...
import me.travja.darkrise.core.legacy.killme.reflections.ConstructorInvoker;
import me.travja.darkrise.core.legacy.killme.reflections.DioriteReflectionUtils;
...
public class DeserializationWorker
{
    ...
    public <T extends ConfigurationSerializable> T deserialize(final String name, final Class<? extends T> clazz, final T def)
    {
    ...
    {
        return this.<T>deserialize(name, (Class<? extends T>) def.getClass(), def);
    }


    public <T extends ConfigurationSerializable, C extends Collection<T>> C deserializeCollection(C collection, final String name, final Class<T> clazz)
    {
    ...
    public <K, V extends ConfigurationSerializable, C extends Map<K, V>> C deserializeSection(C map, String name, final Class<? extends V> clazz, Function<String, K> keyFunc)
    {
        return this.deserializeSection(map, name, clazz, Collections.emptyMap(), keyFunc);
    }

    public <K, V extends ConfigurationSerializable, C extends Map<K, V>> C deserializeSection(C map, String name, final Class<? extends V> clazz, Map<? extends K, ? extends V> def, Function<String, K> keyFunc)
    {
    ...
    public <V extends ConfigurationSerializable, C extends Map<String, V>> C deserializeSection(C map, String name, final Class<? extends V> clazz)
    {
        return this.deserializeSection(map, name, clazz, Collections.emptyMap(), s -> s);
    }

    public <V extends ConfigurationSerializable, C extends Map<String, V>> C deserializeSection(C map, String name, final Class<? extends V> clazz, final Map<String, ? extends V> def)
    {
